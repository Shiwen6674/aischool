...
function buildVoiceInstructions(languageFamily, gender, speed) {
  if (languageFamily === "zh") {
    return [
      ...
      "Read numeric lesson labels such as 1-1 as 一之一, not 1橫線1 or 幺橫線幺.",
      "Read Arabic numeral 1 in Chinese text as Taiwan Mandarin 一/yī, never Mainland-style 幺/yāo.",
